...
<html lang="en">
    <head>        
		...
		<link rel="stylesheet" type="text/css" id="theme" href="css/site.css"/>
        <!-- EOF CSS INCLUDE -->                                     
    </head>
    <body>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6">
						   ...
						   <img src="img/web.jpg">
							   ...
							   <div class="caption">
								   <h3 style="color:#fff">Pemrograman Web</h3>
								   <div class="title">Dosen A</div>
								   <div class="content">
									   <td class="center"><button class="btn btn-success btn-rounded"><i class="fa fa-info-circle"></i><a href="jadwal_web.php"> Informasi </a></button></td>
								   </div>
							   </div>
						   </div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6">
						   <div class="thumbnail img-thumb-bg">
						   <img src="img/jarkom.jpg">
							   <div class="overlay"></div>
							   <div class="caption">
								   <h3 style="color:#fff">Jarkom</h3>
								   <div class="title">Dosen B</div>
								   <div class="content">
									   <td class="center"><button class="btn btn-success btn-rounded"><i class="fa fa-info-circle"></i> Informasi </button></td>
								   </div>
							   </div>
						   </div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-6">
						   <div class="thumbnail img-thumb-bg">
						   <img src="img/delphi.jpg">
							   <div class="overlay"></div>
							   <div class="caption">
								   <h3 style="color:#fff">Visual</h3>
								   <div class="title">Dosen C</div>
								   <div class="content">
									   <td class="center"><button class="btn btn-success btn-rounded"><i class="fa fa-info-circle"></i> Informasi </button></td>
								   </div>
							   </div>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
						   ...
						   <img src="img/java.jpg">
							   <div class="overlay"></div>
							   <div class="caption">
								   <h3 style="color:#fff">Java</h3>
								   <div class="title">Dosen D</div>
								   <div class="content">
									   <td class="center"><button class="btn btn-success btn-rounded"><i class="fa fa-info-circle"></i> Informasi </button></td>
								   </div>
							   </div>
