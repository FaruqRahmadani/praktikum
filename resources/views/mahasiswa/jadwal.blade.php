        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
					...
					<li>
                        <a href="#"><span class="fa fa-th"></span> <span class="xn-text">Jadwal Praktikum</span></a>
                    </li>
					<li>
                                    ...
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <tr>
											  ...
											  <td class="center"><button class="btn btn-info btn-rounded"><i class="fa fa-arrow-circle-o-up"></i> Ambil </button></td>
											</tr>
											<tr>
											  <td>2</td>
