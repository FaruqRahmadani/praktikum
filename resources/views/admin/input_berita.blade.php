           ...
           <form id="formberita" method="post" action="{{Request::url()}}" enctype="multipart/form-data">
				    ...
				    <div class="form-group">
    					<label class="col-sm-2 control-label">Judul Berita</label>
  						<div class="col-sm-10">
    						<input type="text" id="judul_artikel" class="form-control" placeholder="Judul" name="judul_artikel" required><br/>
  						</div>
    				</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="ckeditor" id="ckedtor" name="isi_artikel" required></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="file" id="images" name="gambar_artikel" required/>
							</div>
						</div>
