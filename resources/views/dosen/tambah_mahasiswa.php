    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <li><a href="data_dosen.php" data-toggle="tooltip" title="Go to Data Mahasiswa" data-placement="bottom">Data Mahasiswa</a></li>
                <li><a href="tambah_dosen.php" data-toggle="tooltip" title="Go to Tambah Data" data-placement="bottom">Tambah Data</a></li>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="text-center">
                         <img src="foto/avatar.jpg"" alt="avatar" class="img-rounded img-responsive" class="avatar img-circle" alt="avatar"/>
                      <h6>Ganti foto</h6>
                  ...
                  <div class="col-md-4 personal-info">
                    <div class="alert alert-info alert-dismissable">
                      ...
                      <h4 style="color: #fff"><i class="fa fa-warning"></i>
                        Silakan Isi Data Anda.</h4>        
                    </div>
                    <br>
                    <form class="form-horizontal" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <a href="data_dosen.php" class="btn btn-danger btn-rounded"><span class="fa fa-times" aria-hidden="true"></span>Batal</a>
                          <a href="data_dosen.php" class="btn btn-primary btn-rounded"><span class="fa fa-save" aria-hidden="true"></span>Simpan</a>
                        </div>
                      </div>
                    </form>
                  </div>
