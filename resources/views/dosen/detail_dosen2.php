    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <li><a href="detail_dosen2.php" data-toggle="tooltip" title="Go to Detail Dosen" data-placement="bottom">Detail Dosen</a></li>
                </ul>
            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <img src="foto/alfath.jpg" alt="" class="img-rounded img-responsive" />
                    </div>
